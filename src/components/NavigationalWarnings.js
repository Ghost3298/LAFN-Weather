...
import './styles/NavigationalWarnings.css';
            ...
            {warnings.map((warning, index) => {
                ...
                return (
                    <div key={index} className="warning">
                        ...
                        <p><span  style={{color: "red", fontWeight: "bold", textShadow: ' 1px 1px 0 #000, -1px -1px 0 #000, -1px 1px 0 #000, 1px -1px 0 #000'}} >{warning.type || "N/A"} </span><br/>
